...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWJseSIsImEiOiJjbDBzZHliZzYwNXkyM2lvNTJrdnNldXlzIn0.fINlL_39j4EFBtLYD5SCOA';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/ably/cl0se7aue000s14piubxhz77e',
    // style URL
...
var stripe = Stripe('pk_test_51Kf8zhGDyilsHgPkDSvlQA614k85Yn6MG1j1oPeidi3gkzuZwWKgAkfeQMNfnRAEadc2ryHGsK7vS3ewtTWYTD7P006bPxIkcp');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            document.querySelector('.btn--save-password').textContent = 'Updating ...⌚️';
